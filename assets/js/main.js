; (function ($) {
  ...
  $(document).ready(function () {
    ...
    //========== PAGE PROGRESS STARTS - CORREGIDO ============= // 
    var progressPath = document.querySelector(".progress-wrap path");
    
    // ✅ VERIFICACIÓN AGREGADA PARA EVITAR ERROR
    if (progressPath) {
      ...
      console.log('⚠️ Elemento .progress-wrap path no encontrado - funcionalidad de progreso deshabilitada');
    }
    //========== PAGE PROGRESS ENDS ============= // 
...
//========== TEXT_ANIMATION AREA - CORREGIDO ============= //
// ✅ VERIFICAR QUE GSAP Y SPLITTEXT ESTÉN DISPONIBLES
if (typeof gsap !== 'undefined' && typeof SplitText !== 'undefined') {
  ...
  console.log('⚠️ GSAP o SplitText no están disponibles - animaciones de texto deshabilitadas');
}
//========== TEXT_ANIMATION AREA ============= //

//========== IMAGE ANIMATION - CORREGIDO ============= //
if (typeof gsap !== 'undefined' && $('.reveal').length) {
